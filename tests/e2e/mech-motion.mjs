...
try{
 ...
 for(const [id,speed] of [['forward',50/3.6],['backward',-25/3.6],['left',4],['right',-4]]){
 ...
 await page.locator('#forward').click();await page.waitForFunction(()=>Math.abs(window.mechReview.motion().velocityZ-50/3.6)<.02);
